...
if __name__ == "__main__":
    task_type = "mindmap"
    task_model = "deepseek"
    task_query = "帮我画一个思维导图" + text



    print("开始提交异步任务...")
    tasks_to_submit = [
        (task_type, "deepseek", task_query),
        (task_type, "doubao", task_query),
        (task_type, "qwen", task_query),
    ]

    results_with_time = [] # 存储 (AsyncResult, submit_time)
