...
def run_summary(api_name: str) -> str:
    try:
        summarizer = TextGenerationManager(use_api=api_name, role="summarizer")
        summarizer.set_custom_prompt("请把所有内容翻译为英文",mode="append")
        summary = summarizer.generate_text(text)
